...
function Register() {
    ...
    const registerUser = (e) => {
        ...
        if (text.fullname === "" || text.email === "" || text.password === "" || text.countrycode === "" || text.phoneno === "" || text.imageUrl === "") {
            ...
            <div className="card">
                <div className="left">
                    ...
                    <form onSubmit={(e) => e.preventDefault()}>
                        <input type="text" placeholder="Full Name" required value={text.fullname} onChange={(e) => { setText({ ...text, fullname: e.target.value }) }} />
                        <input type="email" placeholder="Email" required value={text.email} onChange={(e) => { setText({ ...text, email: e.target.value }) }} />
                        <input type="password" placeholder="Password" required value={text.password} onChange={(e) => { setText({ ...text, password: e.target.value }) }} />
                        <select name="phone" required value={text.countrycode} onChange={(e) => { setText({ ...text, countrycode: e.target.value }) }} >
                        ...
                        <input type="number" placeholder="Phone Number" required value={text.phoneno} onChange={(e) => { setText({ ...text, phoneno: e.target.value }) }} />
                        <div>
                            <input className="inputImgFile" type="file" accept=".png, .jpeg, .jpg" required onChange={(e) => setImage(e.target.files[0])} />
                            <button className="uploadImgBtn" onClick={uploadImage}>Upload image</button>
                        </div>
